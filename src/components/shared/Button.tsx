...
{
    const base = "px-6 py-4 rounded-2xl font-black uppercase tracking-wide text-sm " +
    ...
    const variants: Record<string, string> =
    {
        ...
        danger:"bg-brand-primary text-white border-brand-primary hover:opacity-90",
        warning:"bg-orange-500 text-white border-orange-500 hover:opacity-90"
    };
    return(
        <>
